                ...
                {majorOrder.length > 0 ? (
                    majorOrder.map(mo => (
                        <div className='p-3 flex w-full justify-between font-semibold text-BG' key={mo.id}>
                            <div className='flex flex-col w-fit bg-BG items-center justify-between p-3'>
                                <p className='text-ACC truncate'>{mo.overrideTitle}</p>
                                <img src={semo} className='w-20' alt='semo' />
                            </div>
                            <div className='chain flex flex-col items-center mx-4 w-3/4 gap-2'>
                                <h1 className='p-2 bg-BG text-ACC h-fit truncate text-3xl'>A NEW MAJOR ORDER DISPATCHED !</h1>
                                <p className='text-wrap break-words overflow-hidden max-w-screen-2xl'>{mo.overrideBrief}</p>
                                ...
                                <div className='shadow-2xl max-w-screen mx-auto h-fit gap-4 p-4 flex overflow-x-scroll scrolling-auto' >
                               {/* <PlanetTab allCampaign={campaign} >*/}
                                <DesignatedPlanets allCampaign={campaign} />
                                </div>
                            </div>

                            <div className='flex flex-col relative bg-BG items-center justify-between p-3'>
                    ...
                    <div className='m-auto flex flex-col'>
                        ...
                        <p className='text-BG font-bold text-5xl m-auto mt-2'>title</p>
                        <p className='text-BG font-semibold m-auto p-8 text-justify'>status</p>
                    </div>
                )}
            </div>
